...
const AddRoom = () => {
  ...
  return (
    <form className=''>
      ...
      carefully and accurate room details, pricing, and amenities, to enhance the user 
      booking experience"/>
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        ...
        <div className="">
          ...
          p-2 w-24" value={inputs.pricePerNight} onChange={e=> setInputs({...inputs, pricePerNight:
            e.target.value
          })}/>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
        {Object.keys(inputs.amenities).map((amenity,index)=>(
          <div className="" key={index}>
            ...
            <label htmlFor="{`amenities${index+1}`}" className=""> {amenity}</label>
