      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 flex-wrap mt-3 mb-6">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          ...
          molestias id distinctio odit laboriosam illo! Maxime ea inventore
          doloribus ab esse natus omnis nemo recusandae quis cumque culpa
          ducimus corporis exercitationem quasi, minima dolorem iusto hic sed
          reiciendis eius. Obcaecati ex cumque veritatis architecto assumenda
          sequi? Laborum libero numquam iste?
        </div>
